...
uchar const TX_ADDRESS[TX_ADR_WIDTH]  =    {0x00,0xc2,  0xc2,0xc2,  0x00};	//本地地址
uchar const RX0_ADDRESS[RX_ADR_WIDTH]= {0x34,0x43,0x10,0x10,0xFF}; //接收地址 P0  实际地址为：FF-10-10-43-37
...
uchar const RX3_ADDRESS[1]= {0x37}; //接收地址 P3   实际地址为：03-10-10-43-34
uchar const RX4_ADDRESS[1]= {0x38}; //接收地址 P4   实际地址为：03-10-10-43-38
uchar const RX5_ADDRESS[1]= {0x39}; //接收地址 P5  实际地址为：03-10-10-43-39
